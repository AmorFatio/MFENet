...
class ExplorerDataset(YOLODataset):
    ...
    def load_image(self, i: int) -> Union[Tuple[np.ndarray, Tuple[int, int], Tuple[int, int]], Tuple[None, None, None]]:
        """Loads 1 images from dataset index 'i' without any resize ops."""
...
class Explorer:
    """Utility class for images embedding, table creation, and similarity querying using LanceDB and YOLO models."""
    ...
    def query(
        ...
        """
        Query the table for similar images. Accepts a single images or a list of images.

        Args:
            imgs (str or list): Path to the images or a list of paths to the images.
    ...
    def get_similar(
        ...
        Args:
            img (str or list): Path to the images or a list of paths to the images.
            idx (int or list): Index of the images in the table or a list of indexes.
    ...
    def similarity_index(self, max_dist: float = 0.2, top_k: float = None, force: bool = False) -> Any:  # pd.DataFrame
        ...
        are max_dist or closer to the images in the embedding space at a given index.
        ...
        Returns:
            (pandas.DataFrame): A dataframe containing the similarity index. Each row corresponds to an images,
    ...
    def plot_similarity_index(self, max_dist: float = 0.2, top_k: float = None, force: bool = False) -> Image:
        ...
        max_dist or closer to the images in the embedding space at a given index.
        ...
        Example:
            ...
            similarity_idx_plot.show()  # view images preview
        ...
        # Use Pillow to open the images from the buffer
        return Image.fromarray(np.array(Image.open(buffer)))

    def _check_imgs_or_idxs(
        self, img: Union[str, np.ndarray, List[str], List[np.ndarray], None], idx: Union[None, int, List[int]]
    ) -> List[np.ndarray]:
        """Determines whether to fetch images or indexes based on provided arguments and returns images paths."""
    ...
    def ask_ai(self, query):
        ...
        try:
            ...
            LOGGER.error("AI generated query is not val. Please try again with a different prompt")
            LOGGER.error(e)
            return None
